...
const Contact = () => {
  return (
    // <div className="font-poppins my-10 mx-64">
    ...
    //   </div>
    //   <div
    //     className="mt-10 flex  border-2 border-slate-800 rounded-tr-3xl
    ...
    //     </div>
    //     <div />
    //     <form className="w-1/2 mt-20 mb-20 ml-8 flex flex-col px-24 ">
    ...
    //           duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain mr-2 cursor-pointer"
    //                 id="exampleCheck87"
    //                 checked
    //               />
    //               <label
        ...
        <div className="w-1/2 mt-10">
          ...
          <div className="mt-10 ml-5 text-slate-600 ">
            ...
            <div className="flex my-2">
              <div className="w-1/2 ">
                <input className="border-[#086CB6] border-b-2 focus:outline-none" />
              </div>
              <div className="w-1/2">
